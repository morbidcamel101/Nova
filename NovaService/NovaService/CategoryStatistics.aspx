<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CategoryStatistics.aspx.cs" Inherits="NovaService.CategoryStatistics" %>
...
<body style="background-color:#B3CDD3; margin: 0">
    ...
    <div style="background-color:#B3CDD3; width: 100%; height: 100%; position: relative;"  >
        ...
        <asp:Chart ID="LocationChart" runat="server" DataSourceID="NovaDemo" 
            ...
            XValueMember="CategoryName" XValueType="String" YValueMembers="CustomerCount" 
            Color="#B3CDD3">
        ...
        <asp:SqlDataSource ID="NovaDemo" runat="server" 
            ...
            SelectCommand="EXEC Customers.sp_GetCustomersByCategorySummary">
        </asp:SqlDataSource>
